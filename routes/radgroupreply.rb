class Api < Sinatra::Application
	...
	get "/radgroupreply/?", :check => :auth_key? do
		content_type :json
	...
	post "/radgroupreply", :check => :auth_key? do
		content_type :json
	...
	put "/radgroupreply/:id", :check => :auth_key? do
		content_type :json
	...
	delete "/radgroupreply/:id", :check => :auth_key? do
		content_type :json
